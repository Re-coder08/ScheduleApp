"""
Django settings for ScheduleApp_Core project.
...
SECRET_KEY = 'django-insecure-b5l7&w14tkux3(&vj4qmxgh0l5k_fx^36uc6(-6(fv=+5^8)(&'
...
WSGI_APPLICATION = 'ScheduleApp_Core.wsgi.application'
